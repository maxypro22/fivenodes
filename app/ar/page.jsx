    ...
    <main dir="rtl">
      ...
      <CommunicationSection
        ...
        chat={{
          ...
          messages: [
            { from: "them", text: "مساء الخير، هل يوجد شقة ٣ غرف في الدوحة؟", delay: 900 },
            {
              from: "us",
              text: "مساء النور! نعم، لدينا وحدتان متاحتان حالياً في الخليج الغربي بالدوحة، وكلاهما مفروش.",
              delay: 1500,
            },
            {
              from: "us",
              card: {
                ...
                meta: "الخليج الغربي، الدوحة · ١٦٥ م² · مفروشة",
