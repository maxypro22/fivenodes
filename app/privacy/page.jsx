    ...
    <main>
      ...
      <section className="pb-24">
        <div className="wrap max-w-[820px] mx-auto flex flex-col gap-6">
          <p className={P}>
            This Privacy Policy describes how fivenodes.ai, operated by Five
            Nodes for Artificial Intelligence (&quot;we,&quot; &quot;us,&quot; or
            &quot;our&quot;) collects, uses, stores, and shares your personal
            information when you visit or use our website located at
            https://fivenodes.ai (the &quot;Service&quot;). This policy is
            written to comply with applicable privacy laws and the requirements
            of third-party authentication providers including Google and Meta
            (Facebook).
          </p>
          <p className={P}>
            By accessing or using our Service, you agree to the collection and
            use of information as described in this Privacy Policy. If you do not
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              When you choose to log in using your Google account, we receive
              certain information from Google through their OAuth 2.0 service,
              which may include:
            </p>
            <ul className={UL}>
            ...
            <p className={P}>
              We use this information solely for the purpose of creating and
              managing your account on fivenodes.ai and granting you
              authenticated access to the FiveNodes AI Monitoring System demo. We
              do not access your Google contacts, Google Drive, Gmail, or any
              other Google services beyond the basic profile information required
              for authentication. We will never sell your Google user data to
              third parties. Our use of information received from Google APIs is
              limited to the practices described in this Privacy Policy, in
              compliance with the Google API Services User Data Policy, including
              the Limited Use requirements.
            </p>

            <h3 className={H3}>
              1.3 Information Collected via Meta (Facebook) Login
            </h3>
            <p className={P}>
              When you choose to log in using your Meta (Facebook) account, we
              receive certain information from Meta through their Login API,
              which may include:
            </p>
            <ul className={UL}>
            ...
            <p className={P}>
              We use this data only to create and authenticate your account on
              fivenodes.ai and grant you access to the FiveNodes AI Monitoring
              System demo. We do not access your Facebook friends list, posts,
              messages, or any other Meta data beyond the basic profile
              information required for login. We comply with Meta&apos;s Platform
              Terms and Developer Policies regarding the use of data obtained via
              Meta Login.
            </p>
            ...
            <p className={P}>
              ...
              your session, remember your preferences, and analyze how our
              Service is used. You may control cookie settings through your
              browser. Please note that disabling cookies may affect the
              functionality of certain features, including social login options.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className={UL}>
              ...
              <li>
                To send you important notices, security alerts, or policy updates
              </li>
            ...
            <ul className={UL}>
              ...
              <li>
                Sending unsolicited marketing emails without your consent
              </li>
              <li>
                Using Google or Meta user data for purposes beyond those
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              We may engage trusted third-party vendors to help operate our
              Service, such as cloud hosting providers, analytics platforms, and
              email delivery services. These parties are contractually
              prohibited from using your data for any purpose other than
            ...
            <p className={P}>
              ...
              or government authority, or if we believe in good faith that such
            ...
            <p className={P}>
              ...
              notify you via email or a prominent notice on our website before
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              ...
              active or as needed to provide you with our Service. We also retain
              data as necessary to comply with our legal obligations, resolve
              disputes, and enforce our agreements.
            </p>
            <p className={P}>
              When you delete your account, we will delete or anonymize your
              personal information within 30 days, unless retention is required
              by law. Authentication tokens from Google and Meta are not stored
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              ...
              contacting us at info@fivenodes.ai.
            </p>

            <h3 className={H3}>6.2 Data Deletion</h3>
            <p className={P}>
              You may request the deletion of your account and associated
              personal data by contacting us at info@fivenodes.ai. Upon receiving
              a verified request, we will delete your data within 30 days,
              subject to any legal retention obligations.
            </p>

            <h3 className={H3}>6.3 Revoking Third-Party Access</h3>
            <p className={P}>
              You may revoke fivenodes.ai&apos;s access to your Google account at
              any time through your Google Account Security settings at
              myaccount.google.com. You may revoke access to your Meta account at
              any time through Facebook Settings &gt; Apps and Websites.
            </p>

            <h3 className={H3}>6.4 Opt-Out of Communications</h3>
            <p className={P}>
              You may opt out of non-essential email communications by clicking
              the unsubscribe link in any marketing email, or by adjusting
            ...
            <p className={P}>
              ...
              you have additional rights under the GDPR, including the right to
              data portability, the right to restrict processing, and the right
            ...
            <p className={P}>
              ...
              personal information we collect, the right to request deletion, and
              the right to opt out of the sale of personal information. We do not
              sell personal information. To exercise your rights, contact us at
              info@fivenodes.ai.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              ...
              please contact us immediately at info@fivenodes.ai and we will
              delete it promptly. In compliance with the Google API Services User
              Data Policy, we do not use Google Sign-In in applications primarily
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              ...
              than your own. By using our Service, you consent to the transfer of
              your information to countries that may have different data
              protection laws than your country of residence. Where required, we
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              ...
              including those of Google and Meta. We are not responsible for the
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              ...
              page. If we make material changes to how we use your personal
              information, we will notify you by email or through a prominent
              notice on our website prior to the changes taking effect, and we
              will seek your renewed consent where required by law.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className={P}>
              For Google-related data inquiries, we will respond within 30 days.
              For GDPR-related requests, we will respond within the legally
              required timeframes.
            </p>
          </div>
