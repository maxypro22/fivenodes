...
export const metadata = pageMeta({
  ...
  description:
    "رؤى ومقالات متخصصة حول أتمتة الذكاء الاصطناعي، وكلاء الصوت، وأتمتة سير العمل. من فايف نودز لحلول الذكاء الاصطناعي في قطر.",
  path: "/blog",
  ogTitle: "مدونة أتمتة الذكاء الاصطناعي — قطر | فايف نودز",
  locale: "ar",
});
